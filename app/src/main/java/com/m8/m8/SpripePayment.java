...
public class SpripePayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spripe_payment);

        getWindow().setSoftInputMode(
                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);

        AppCompatActivity activity = SpripePayment.this;
        activity.setSupportActionBar(toolbar);

        userId = getIntent().getStringExtra("userId");
        shareId = getIntent().getStringExtra("shareId");
        imageForStripe = getIntent().getStringExtra("imageForStripe");
        SharedToken sharedToken = new SharedToken(SpripePayment.this);
...
//                final ProgressDialog myDialog = ProgressBarClass.showProgressDialog(SpripePayment.this, "Please wait for a while...");
//                myDialog.show();
                ...
                {
                    Toast.makeText(SpripePayment.this, "Fill your details.", Toast.LENGTH_SHORT).show();
                    ...
                    dialog = ProgressBarClass.showProgressDialog(SpripePayment.this, "Please wait");
                    dialog.show();
...
//            editLogin.setText(shared.getString("lem", ""));
    ...
    public void onClickSomething(final String cardNumber, final String cardExpMonth, final String cardExpYear, final String cardCVC) {
        ...
        //Stripe stripe = new Stripe(SpripePayment.this, "pk_test_7nMgS2ZoQnOOId6BtAZ0u5Jw00TXVNccdT");
        Stripe stripe = new Stripe(SpripePayment.this, PUBLISH_KEY_STRIPE);
        stripe.createToken(card, new TokenCallback() {
            @Override
            public void onError(@NonNull Exception error) {
                Log.d("card_token", "card " + error);
                Toast.makeText(SpripePayment.this, ""+error, Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
...
//        final ProgressDialog dialog = ProgressBarClass.showProgressDialog(SpripePayment.this, "Please wait");
//        dialog.show();
        call.enqueue(new Callback<SendPlanData>() {
            ...
            public void onResponse(Call<SendPlanData> call, Response<SendPlanData> response) {
                ...
                if (response.body().getStatus()==200) {
                    Toast.makeText(SpripePayment.this, "Payment Sucessful", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(SpripePayment.this,HomeActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(SpripePayment.this, "" + response.body().getMessage(), Toast.LENGTH_LONG).show();
                    dialog.dismiss();
                }
            }
            ...
            public void onFailure(Call<SendPlanData> call, Throwable t) {
                dialog.dismiss();
                Toast.makeText(SpripePayment.this, "" + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        call.enqueue(new Callback<GetPlanApi>() {
            ...
            public void onResponse(Call<GetPlanApi> call, Response<GetPlanApi> response) {
                ...
                if (response.isSuccessful()) {
                    for (int i = 0; i < response.body().getData().size(); i++) {
                        ...
                        if (shareId.equals("2")) {
                            ...
                            else
                            {
                                ...
                                paybutton.setText("PAY USD "+ datum.getPlanPrice().toString());
                            }
                    ...
                    Toast.makeText(SpripePayment.this, "" + response.message(), Toast.LENGTH_LONG).show();
                }
