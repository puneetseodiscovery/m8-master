...
public class StripeConnectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedToken sharedToken = new SharedToken(StripeConnectActivity.this);
        String userId = sharedToken.getUserId();
        //https://connect.stripe.com/oauth/authorize?response_type=code&client_id=ca_G9vPCANGPN4Jv1FJOOGjOOMcA9hbltKZ&scope=read_write&state=17#
        //https://connect.stripe.com/oauth/authorize?response_type=code&client_id=ca_G9vPRg6nsFomd4zCtHhY2pEq03Ljkrpc&scope=read_write&state=
        String urlWithId = "https://connect.stripe.com/oauth/authorize?response_type=code&client_id=ca_G9vPCANGPN4Jv1FJOOGjOOMcA9hbltKZ&scope=read_write&state="+userId;
