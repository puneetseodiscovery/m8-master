...
public class UtileDilog {
    ...
    public static Dialog dialog(final Context context, String txtTile, String Buy, final FragmentManager fragmentManager) {
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.framelayout, sharePackageFragment);
