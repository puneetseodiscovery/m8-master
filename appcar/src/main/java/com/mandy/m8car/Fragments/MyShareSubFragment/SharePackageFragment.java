package com.mandy.m8car.Fragments.MyShareSubFragment;
...
import com.mandy.m8car.util.Config;
...
public class SharePackageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView.setText("Our Share Package");
    ...
    private void PaymentProgress(String id, String plan) {
        PayPalPayment payPalPayment = new PayPalPayment(new BigDecimal(String.valueOf(amount)), "CHF", "Purchase the " + plan + " share package", PayPalPayment.PAYMENT_INTENT_SALE);
                ...
                if (response.isSuccessful()) {
                    for (int i = 0; i < response.body().getData().size(); i++) {
                        if (i == 0) {
                            ...
                            txtFreePrice.setText(sharedRate.getCurrencyCode() + "\n" +  String.format("%.2f", price));
                        ...
                        if (i == 1) {
                            ...
                            double price = Double.valueOf(sharedRate.getShared()) * Double.valueOf(datum.getPlanPrice());
                            txtNovicePrice.setText(sharedRate.getCurrencyCode() + "\n" +  String.format("%.2f", price));
                        ...
                        if (i == 2) {
                            ...
                            double price = Double.valueOf(sharedRate.getShared()) * Double.valueOf(datum.getPlanPrice());
                            txtPlayerPrice.setText(sharedRate.getCurrencyCode() + "\n" +  String.format("%.2f", price));
                        ...
                        if (i == 3) {
                            ...
                            txtProPrice.setText(sharedRate.getCurrencyCode() + "\n" +  String.format("%.2f", price));
                        ...
                        if (i == 4) {
                            ...
                            txtBusinessPrice.setText(sharedRate.getCurrencyCode() + "\n" +  String.format("%.2f", price));
