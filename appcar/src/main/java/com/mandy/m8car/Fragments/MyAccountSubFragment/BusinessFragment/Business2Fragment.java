package com.mandy.m8car.Fragments.MyAccountSubFragment.BusinessFragment;
...
public class Business2Fragment extends Fragment {
    ...
    private void getShareData() {
        ...
        Call<ProfileDataApi> call = apiInterface.getShareProfileApi(HomeActivity.userId, bType, bName, bContact, bEmail, bPhone, bAddress1,
                bAddress2, bCity, bPostcode, bCountry, Lname, Lemail, Lphone, Laddress1, Laddress2, Lcity, Lpostcode, Lcountry);
    ...
    private void seEdittData() {
        if (ViewProfileFragment.data.getProfile() != null) {
            ...
            edtLaddress1.setText(ViewProfileFragment.data.getProfile().getLeagalAddress());
            edtLaddress2.setText(ViewProfileFragment.data.getProfile().getLeagalAddress2());
